...
<body>
  ...
  <section class="home">
    <div id="carouselExampleIndicators" class="carousel slide">
      <div class="carousel-controls">
        ...
        <div class="carousel-indicators">
          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active"
            aria-current="true" aria-label="Slide 1" style="background-image: url(images/1.jpg);"></button>
          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"
            style="background-image: url(images/145011.jpg);"></button>
          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"
            style="background-image: url(images/2017-mercedes-benz-metris-review.jpg);"></button>
        </div>
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item" style="background-image: url(images/145011.jpg);">
          <div class="container">
            <h2>4WD & SUV Vehicles</h2>
            <p>Discover adventure in our versatile 4WD and SUVs.</p>
          </div>
        </div>
        <div class="carousel-item" style="background-image: url(images/2017-mercedes-benz-metris-review.jpg);">
          <div class="container">
  ...
  <div class="container-fluid mx-auto">
    ...
    <div class="row g-4 mt-4 mb-5">
      <div class="col-md-3">
        <div class="card">
          <img src="images/mitsubishi-montero-sri-lanka.jpg" alt="..." class="">
          <div class="card-body">
      ...
      <div class="col-md-3">
        <div class="card">
          <img src="images/daitatsu-terios-sri-lanka.jpg" alt="..." class="">
          <div class="card-body">
      ...
      <div class="col-md-3">
        <div class="card">
          <img src="images/perodua-bezza-prime-sedan-sri-lanka.jpg" alt="..." class="">
          <div class="card-body">
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4">
    <div class="col">
      <div class="card h-100">
        <img src="images/toyota-premio-sri-lanka.jpg" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card h-100">
        <img src="images/mercedes-benz-new-e-class-sri-lanka.jpg" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col">
      <div class="card h-100">
        <img src="images/Toyota-Rav-4.jpg" class="card-img-top" alt="...">
        <div class="card-body">
