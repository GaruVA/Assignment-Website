<?php
    ...
    $sql_delete_order = "DELETE FROM `luxedrive_orders` WHERE order_confirm='pending';";
                ...
                <div class="col-md-9">
                    <?php 
                        if(isset($_POST["update"])) {
                            ...
                            $sql_update_user="UPDATE `luxedrive_users` SET user_firstname='$user_firstname',user_lastname='$user_lastname',user_contact='$user_contact',user_address_street='$user_address_street',user_address_city='$user_address_city',user_address_state='$user_address_state' WHERE user_email='$user_email'";
                        ...
                        if(isset($_GET["delete"])) {
                            $sql_delete_user = "DELETE FROM `luxedrive_users` WHERE user_email='$user_email';";
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="p-4">
                        ...
                        <div class="mb-3">
                            <label for="user_address_street" class="form-label">Street Address:</label>
                            <input type="text" id="user_address_street" name="user_address_street" value="<?php echo $user_address_street?>" class="form-control" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" id="user_contact" name="user_contact" title="Format: 0XXXXXXXXX" pattern="0[0-9]{9}" value="<?php echo $user_contact?>" class="form-control" required>
                        </div>
                        <div class="buttons">
