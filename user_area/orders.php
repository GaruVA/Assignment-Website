                ...
                <div class="col-md-9">
                    <?php
                        if(isset($_GET["delete"])) {
                          ...
                          $sql_delete_order = "DELETE FROM `luxedrive_orders` WHERE order_id=$order_id";
                          $result_delete_order = mysqli_query($conn,$sql_delete_order);
                          if($result_delete_order){
                              echo "<script>alert('Success: Order \"$order_invoice\" has been deleted.')</script>";
                    ...
                    <table>
                            ...
                            <tbody>
                                <?php
                                    $sql_select_orders = "SELECT * FROM `luxedrive_orders` WHERE user_id=$user_id;";
