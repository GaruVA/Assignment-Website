<?php
    if(isset($_POST["submit"])){
        ...
        $sql_check_duplicate = "SELECT * FROM `luxedrive_categories` WHERE category_name='$category_name';";
        ...
        if ($row_count != 0) {
            ...
            $sql_insert_category = "INSERT INTO `luxedrive_categories` (category_name) VALUES ('$category_name');";
