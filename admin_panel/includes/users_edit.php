<?php 
    ...
    if(isset($_POST["update"])) {
        ...
        $sql_update_user="UPDATE `luxedrive_users` SET user_type='$new_user_type' WHERE user_id='$user_id'";
        $result_update_user = mysqli_query($conn,$sql_update_user);
        if ($result_update_user) {
            echo "<script>alert('Success: User \"$user_email\" has been updated.'); window.location.href = 'users.php?view';</script>";
        } else {
...
<form action="" method="post" enctype="multipart/form-data" class="p-4">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="user_address_street" name="user_address_street" value="<?php echo $user_address_street?>" class="form-control" required disabled>
    </div>
    ...
    <div class="row mb-3">
        ...
        <input type="tel" id="user_contact" name="user_contact" title="Format: 0XXXXXXXXX" pattern="0[0-9]{9}" value="<?php echo $user_contact?>" class="form-control" required disabled>
        </div>
        <div class="col-md-6">
