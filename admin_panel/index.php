            ...
            <div id="main">
                ...
                <div class="col-md-3">
                        <div class="card">
                            <div>
                            <p>Categories</p>
                                <h2> <?php $sql_select_category="SELECT * FROM `luxedrive_categories`";
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div>
                            <p>Products</p>
                                <h2> <?php $sql_select_products="SELECT * FROM `luxedrive_products`";
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div>
                            <p>Orders</p>
                                <h2> <?php $sql_select_orders="SELECT * FROM `luxedrive_orders`";
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div>
                            <p>Users</p>
                                <h2> <?php $sql_select_users="SELECT * FROM `luxedrive_users`";
                    ...
                    <div id="main2">
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php
                                    $sql_select_orders = "SELECT * FROM `luxedrive_orders` WHERE DATE(order_date) = CURDATE() ORDER BY order_date DESC;";
                                    $result_select_orders = mysqli_query($conn, $sql_select_orders);
