      ...
      <div class="col-md-6" id="left">
        ...
        <form action="" method="POST">
          <div class="input-field">
            <input type="text" name="name" id="name" value="<?php echo $user_name; ?>" placeholder=" " required>
            <label for="name">Name</label>
          </div>
          <div class="input-field">
            <input type="email" name="email" id="email" value="<?php echo $user_email; ?>" placeholder=" " required>
