...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarID">
        ...
        <div class="nav-link nav-center right">
          ...
          <a href='user_area/index.php' class='nav-icon'>
            <i class="fa-solid fa-user" style="color: #f4f0f0;"></i>
          </a>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="four col-md-2">
        <div class="counter-box">
          ...
          <span class="counter">
          <?php 
            $sql_select_products = "SELECT * FROM `luxedrive_products`;";
  ...
  <div class="row">
    ...
    <div class="col-lg-4 mb-3 mb-lg-0">
      <div class="hover hover-1 text-white rounded"><img src="images/IMG_3071.jpg" alt="">
    ...
    <!-- DEMO 2 Item-->
    <div class="col-lg-4">
      <div class="hover hover-1 text-white rounded"><img src="images/garuka.JPG" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
  ...
  <div class="row">
    <!-- DEMO 3 Item-->
    <div class="col-lg-4 mb-3 mb-lg-0">
      <div class="hover hover-1 text-white rounded"><img src="images/pubudu.jpeg" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
    ...
    <!-- DEMO 4 Item-->
    <div class="col-lg-4">
      <div class="hover hover-1 text-white rounded"><img src="images/mudith.jpeg" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
  ...
  <div class="row">
    <!-- DEMO 5 Item-->
    <div class="col-lg-4 mb-3 mb-lg-0">
      <div class="hover hover-1 text-white rounded"><img src="images/isuru.JPG" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
    ...
    <!-- DEMO 6 Item-->
    <div class="col-lg-4">
      <div class="hover hover-1 text-white rounded"><img src="images/dion.jpg" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
  ...
  <div class="row">
    <!-- DEMO 7 Item-->
    <div class="col-lg-4 mb-3 mb-lg-0">
      <div class="hover hover-1 text-white rounded"><img src="images/yehan.jpeg" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
    ...
    <!-- DEMO 8 Item-->
    <div class="col-lg-4">
      <div class="hover hover-1 text-white rounded"><img src="images/chanodya.jpg" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
  ...
  <div class="row">
    <!-- DEMO 9 Item-->
    <div class="col-lg-4 mb-3 mb-lg-0">
      <div class="hover hover-1 text-white rounded"><img src="images/thamidu.jpeg" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
    ...
    <!-- DEMO 10 Item-->
    <div class="col-lg-4">
      <div class="hover hover-1 text-white rounded"><img src="images/shiraz.JPG" alt="">
        <div class="hover-overlay"></div>
        <div class="hover-1-content px-5 py-4">
